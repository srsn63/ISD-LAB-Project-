...
<head>
    ...
    <title>Careers - Lalon Airport</title>
    ...
    <style>
        ...
        @media(min-width:900px){.jobs{grid-template-columns:1fr 1fr}}
        .job{background:rgba(30,41,59,.7);border:1px solid rgba(59,130,246,.15);border-radius:14px;padding:18px}
        .job h3{color:#fff;margin-bottom:6px} .job .meta{font-size:.9rem;color:var(--text-muted)}
...
<main class="container">
    <section class="card">
        <h1>Careers</h1>
        <p>Join a team that's reimagining airport experiences. Explore opportunities across operations, technology, customer experience, and more.</p>
        <div class="jobs">
            <div class="job">
                <h3>Airport Operations Officer</h3>
                <p class="meta">Dhaka • Full-Time</p>
                <p>Ensure smooth, safe, and efficient daily operations across terminals and airfield services.</p>
            </div>
            <div class="job">
                <h3>Software Engineer (Flight Systems)</h3>
                <p class="meta">Remote • Full-Time</p>
                <p>Build reliable platforms for scheduling, booking, and real-time operations.</p>
            </div>
        </div>
    </section>
