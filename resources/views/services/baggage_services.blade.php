...
<head>
    ...
    <title>Baggage Services - Lalon Airport</title>
...
<body>
    ...
    <header class="topbar">
        <a class="brand" href="{{ route('home') }}"><i class="fa-solid fa-suitcase-rolling"></i> Lalon Airport</a>
        <a class="back-btn" href="{{ route('home') }}"><i class="fa-solid fa-arrow-left"></i> Back to Home</a>
    </header>
    <main class="container">
        <section class="card">
            <h1>Baggage Services</h1>
            <p>From check‑in to arrival, our baggage services keep your belongings safe and on time.</p>
            <div class="grid">
                <div class="feature">
                    <h3>Baggage Allowance</h3>
                    <p class="muted">Know your free allowance and fees for extra or overweight bags.</p>
                </div>
                <div class="feature">
                    <h3>Priority Handling</h3>
                    <p class="muted">Add priority tags for faster delivery at your destination.</p>
                </div>
                <div class="feature">
                    <h3>Special Items</h3>
                    <p class="muted">We handle strollers, instruments, sports gear, and fragile items with care.</p>
                </div>
                <div class="feature">
                    <h3>Lost & Found</h3>
                    <p class="muted">Report and track missing baggage with proactive updates.</p>
                </div>
            </div>
        </section>
    </main>
