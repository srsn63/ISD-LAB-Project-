...
<head>
    ...
    <title>Flight Booking - Lalon Airport</title>
...
<body>
    ...
    <header class="topbar">
        <a class="brand" href="{{ route('home') }}"><i class="fa-solid fa-plane-departure"></i> Lalon Airport</a>
        <a class="back-btn" href="{{ route('home') }}"><i class="fa-solid fa-arrow-left"></i> Back to Home</a>
    </header>
    <main class="container">
        <section class="card">
            <h1>Flight Booking</h1>
            <p>Book flights quickly and securely with our streamlined booking experience. Compare fares, choose seats, and manage extras with ease.</p>
            <div class="grid">
                <div class="feature">
                    <h3>Flexible Search</h3>
                    <p class="muted">Find the best options by date, destination, and class—Economy, Business, or First.</p>
                </div>
                <div class="feature">
                    <h3>Secure Payments</h3>
                    <p class="muted">Pay with cards, mobile wallets, or bank transfer with bank‑grade encryption.</p>
                </div>
                <div class="feature">
                    <h3>Manage Booking</h3>
                    <p class="muted">Modify traveler details, add baggage, or upgrade seats, all in one place.</p>
                </div>
                <div class="feature">
                    <h3>E‑tickets & Alerts</h3>
                    <p class="muted">Receive instant e‑tickets and real‑time updates on flight changes.</p>
                </div>
            </div>
        </section>
    </main>
