...
<head>
    ...
    <title>Online Check‑in - Lalon Airport</title>
...
<body>
    ...
    <main class="container">
        <section class="card">
            ...
            <p>Skip queues and save time by checking in online. Choose seats, add baggage, and download your digital boarding pass.</p>
            <div class="grid">
                <div class="feature">
                    <h3>Early Access</h3>
                    <p class="muted">Check‑in opens up to 24–48 hours before departure depending on the airline.</p>
                </div>
                <div class="feature">
                    <h3>Seat Selection</h3>
                    <p class="muted">Pick your preferred seats and upgrade to extra legroom if available.</p>
                </div>
                <div class="feature">
                    <h3>Boarding Pass</h3>
                    <p class="muted">Receive a mobile boarding pass instantly—no printing required.</p>
                </div>
                <div class="feature">
                    <h3>Baggage Options</h3>
                    <p class="muted">Add or pay for extra baggage with transparent pricing.</p>
                </div>
            </div>
        </section>
    </main>
