        ...
        <div class="card">
            ...
            <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>">
                ...
                <div class="field">
                    ...
                    <input id="email" type="email" name="email" class="input" placeholder="admin@example.com" value="<?php echo e(old('email')); ?>" required autofocus>
                </div>
                <div class="field">
            ...
            <div class="row" style="margin-top:1rem;">
                <div class="links">
                    <a href="<?php echo e(Route::has('home') ? route('home') : url('/')); ?>"><i class="fas fa-house"></i> Back to Home</a>
                </div>
                <div class="links">
                    <a href="<?php echo e(route('admin.login')); ?>"><i class="fas fa-rotate-right"></i> Reset</a>
                </div>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\HP\example-app\resources\views/admin_login.blade.php ENDPATH**/ ?>