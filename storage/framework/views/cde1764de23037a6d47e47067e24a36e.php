...
<body>
    ...
    <!-- View Message Modal -->
    <div id="modalViewMessage" class="modal" aria-hidden="true">
        <div class="modal-card card" role="dialog" aria-modal="true" aria-labelledby="viewMessageTitle">
            <h2 id="viewMessageTitle"><i class="fas fa-envelope-open"></i> Contact Message</h2>
            <div class="modal-body">
                <div class="form-grid">
                    <div>
                        <label>From:</label>
                        <div id="msg-from" style="padding: 0.5rem 0; font-weight: 600;"></div>
                    </div>
                    <div>
                        <label>Email:</label>
                        <div id="msg-email" style="padding: 0.5rem 0; color: var(--sky-blue);"></div>
                    </div>
                    <div class="full">
                        <label>Subject:</label>
                        <div id="msg-subject" style="padding: 0.5rem 0; font-weight: 600;"></div>
                    </div>
                    <div class="full">
                        <label>Received:</label>
                        <div id="msg-date" style="padding: 0.5rem 0; color: var(--text-muted);"></div>
                    </div>
                    <div class="full">
                        <label>Message:</label>
                        <div id="msg-content" style="padding: 0.75rem 1rem; background: rgba(15,23,42,0.75); border: 1px solid rgba(59,130,246,0.35); border-radius: 10px; max-height: 200px; overflow-y: auto; white-space: pre-wrap; line-height: 1.5;"></div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn alt" data-close="#modalViewMessage"><i class="fas fa-xmark"></i> Close</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.querySelectorAll('[data-action="view-message"]').forEach(btn => {
            btn.addEventListener('click', () => {
                const name = btn.getAttribute('data-name');
                const email = btn.getAttribute('data-email');
                ...
                document.getElementById('msg-from').textContent = name;
